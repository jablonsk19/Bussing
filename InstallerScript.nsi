...
Section "MainSection" SEC01
  ...
  File "C:\Users\dterm\PycharmProjects\HTA\HTA\dist\hta.exe"
  CreateDirectory "$SMPROGRAMS\HTA"
  CreateShortCut "$SMPROGRAMS\HTA\HTA.lnk" "$INSTDIR\hta.exe"
  CreateShortCut "$DESKTOP\HTA.lnk" "$INSTDIR\hta.exe"
SectionEnd
...
Section Uninstall
  ...
  Delete "$INSTDIR\hta.exe"
  Delete "$INSTDIR\Uninstall-HTA.exe"
